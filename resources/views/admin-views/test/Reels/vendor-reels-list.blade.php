                    ...
                    <nav>
                        <ul class="pagination">
                            ...
                            <li class="page-item"><a class="page-link"
                                    href="http://localhost/Aduanefie/admin/order/list/all?page=2">2</a></li>
                            <li class="page-item"><a class="page-link"
                                    href="http://localhost/Aduanefie/admin/order/list/all?page=3">3</a></li>
                            <li class="page-item"><a class="page-link"
                                    href="http://localhost/Aduanefie/admin/order/list/all?page=4">4</a></li>
                            <li class="page-item"><a class="page-link"
                                    href="http://localhost/Aduanefie/admin/order/list/all?page=5">5</a></li>
                            <li class="page-item"><a class="page-link"
                                    href="http://localhost/Aduanefie/admin/order/list/all?page=6">6</a></li>
                            <li class="page-item"><a class="page-link"
                                    href="http://localhost/Aduanefie/admin/order/list/all?page=7">7</a></li>
                            <li class="page-item"><a class="page-link"
                                    href="http://localhost/Aduanefie/admin/order/list/all?page=8">8</a></li>
        
        
                            <li class="page-item">
                                <a class="page-link" href="http://localhost/Aduanefie/admin/order/list/all?page=2" rel="next"
                                    aria-label="Next »">›</a>
                            </li>
                        </ul>
                    </nav>
