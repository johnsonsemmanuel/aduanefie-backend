        ...
        <div class="">
            <div class="js-nav-scroller hs-nav-scroller-horizontal mt-3">
                ...
                <ul class="nav nav-tabs nav--pills mb-3 border-0 nav--tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="http://localhost/Backend-Aduanefie/admin/users/delivery-man/preview/6/disbursement" aria-disabled="true">Loyalty Point</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="http://localhost/Backend-Aduanefie/admin/users/delivery-man/preview/6/disbursement" aria-disabled="true">Refer & Earn</a>
                    </li>
                </ul>
                <!-- End Nav -->
            </div>
