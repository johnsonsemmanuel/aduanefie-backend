...
@section('content')
    ...
    :asset('/public/assets/admin/img/400x400/deliveryman-dirver.png') }}"
                                ...
                                <div class="mt-xl-0 mt-2 max-w-353px">
                                    ...
                                    @else
                                        <p class="text-title fs-12 mb-xxl-4 mb-xl-3 mb-3">
                                            {{$download_dm_app_sub_title?->value ?? 'Join Aduanefie as a delivery partner and turn every ride into income. Work on your own schedule and get paid faster, every day'}}
                                        </p>
