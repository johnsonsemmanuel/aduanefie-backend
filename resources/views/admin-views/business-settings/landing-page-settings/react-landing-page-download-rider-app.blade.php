...
@section('content')
    <div class="content container-fluid">
            ...
            <div class="d-flex flex-sm-nowrap flex-wrap gap-3 align-items-center justify-content-between">
                ...
                <div class="max-w-300px ml-sm-auto">
                    <button type="button" class="btn btn-outline-primary py-2 fs-12 px-3 offcanvas-trigger"
                            data-target="#rider-downloadApp_section">
        ...
        @php($download_rider_app_section_status = \App\Models\DataSetting::where('type', 'react_landing_page')->where('key', "download_rider_app_section_status")->first())
            ...
            <div class="row g-3 align-items-center justify-content-between">
                ...
                <div class="col-xxl-3 col-lg-4 col-md-5 col-sm-6">
                    <div class="py-2 px-3 rounded d-flex justify-content-between border align-items-center w-300">
                        ...
                        <form
                            action="{{ route('admin.business-settings.statusUpdate', ['type' => 'react_landing_page', 'key' => 'download_rider_app_section_status']) }}"
        ...
        <div class="card mb-20">
            <form class="custom-validation" action="{{ route('admin.business-settings.react-landing-page-settings-update', 'download-rider-app-section') }}"
                ...
                <div class="card-body">
                    ...
                    @php($download_rider_app_title = \App\Models\DataSetting::withoutGlobalScope('translate')->where('type', 'react_landing_page')->where('key', 'download_rider_app_title')->first())
                    @php($download_rider_app_sub_title = \App\Models\DataSetting::withoutGlobalScope('translate')->where('type', 'react_landing_page')->where('key', 'download_rider_app_sub_title')->first())
                    @php($download_rider_app_button_title = \App\Models\DataSetting::withoutGlobalScope('translate')->where('type', 'react_landing_page')->where('key', 'download_rider_app_button_title')->first())
                    @php($download_rider_app_image = \App\Models\DataSetting::withoutGlobalScope('translate')->where('type', 'react_landing_page')->where('key', 'download_rider_app_image')->first())
                            ...
                            <div class="bg--secondary rounded h-100 p-xxl-4 p-3">
                                ...
                                <div class="row g-3">
                                    @if ($language)
                                        <div class="col-md-12 lang_form default-form">
                                            <div class="row g-1">
                                                <div class="col-12">
                                                    ...
                                                    <input id="download_rider_app_title" type="text" maxlength="50"
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input id="download_rider_app_button_title" type="text" maxlength="20"
                                        ...
                                        @foreach($language as $lang)
                                                <?php
                                                $download_rider_app_title_translate = [];
                                                $download_rider_app_sub_title_translate = [];
                                                $download_rider_app_button_title_translate = [];

                                                if (isset($download_rider_app_title->translations) && count($download_rider_app_title->translations)) {
                                                    foreach ($download_rider_app_title->translations as $t) {
                                                        if ($t->locale == $lang && $t->key == 'download_rider_app_title') {
                                                            $download_rider_app_title_translate[$lang]['value'] = $t->value;
                                                        }
                                                    }
                                                }

                                                if (isset($download_rider_app_sub_title->translations) && count($download_rider_app_sub_title->translations)) {
                                                    foreach ($download_rider_app_sub_title->translations as $t) {
                                                        if ($t->locale == $lang && $t->key == 'download_rider_app_sub_title') {
                                                            $download_rider_app_sub_title_translate[$lang]['value'] = $t->value;
                                                        }
                                                    }
                                                }

                                                if (isset($download_rider_app_button_title->translations) && count($download_rider_app_button_title->translations)) {
                                                    foreach ($download_rider_app_button_title->translations as $t) {
                                                        if ($t->locale == $lang && $t->key == 'download_rider_app_button_title') {
                                                            $download_rider_app_button_title_translate[$lang]['value'] = $t->value;
                                                        }
                                                    }
                                                }
                                                ?>
                                            <div class="col-md-12 d-none lang_form" id="{{$lang}}-form">
                                                <div class="row g-1">
                                                    <div class="col-12">
                                                        <label for="download_rider_app_title{{$lang}}"
                                                               class="form-label">{{translate('Title')}}
                                                        ...
                                                        <input id="download_rider_app_title{{$lang}}" type="text"
                                                               maxlength="100"
                                                               name="download_rider_app_title[]"
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input id="download_rider_app_button_title{{$lang}}" type="text"
                                                               maxlength="20"
                                                               name="download_rider_app_button_title[]"
                                    ...
                                    @else
                                        <div class="col-12">
                                            ...
                                            <div class="mb-4">
                                                <label for="download_rider_app_sub_title"
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="mx-auto text-center error-wrapper">
                                        <div class="upload-file_custom ratio-1 h-100px">
                                            <input type="file" name="download_rider_app_image"
                                                   class="upload-file__input single_file_input"
                                                   accept=".webp, .jpg, .jpeg, .png, .gif" {{ $download_rider_app_image?->value ? '' : 'required' }}>
                                            <label class="upload-file__wrapper w-100 h-100 m-0">
                                                <div class="upload-file-textbox text-center"
                                                     style="{{ $download_rider_app_image?->value ? 'display: none;' : '' }}">
                                                ...
                                                <img class="upload-file-img" loading="lazy" src="{{ $download_rider_app_image?->value
    ? \App\CentralLogics\Helpers::get_full_url('download_rider_app_section', $download_rider_app_image->value, $download_rider_app_image->storage[0]?->value ?? 'public', 'aspect_1')
    : '' }}" data-default-src="{{ $download_rider_app_image?->value
    ? \App\CentralLogics\Helpers::get_full_url('download_rider_app_section', $download_rider_app_image->value, $download_rider_app_image->storage[0]?->value ?? 'public', 'aspect_1')
    : '' }}" alt=""
                                                     style="{{ $download_rider_app_image?->value ? 'display: block;' : 'display: none;' }}">
                                            </label>
                                            <div class="overlay"
                                                 style="{{ $download_rider_app_image?->value ? 'display: block;' : 'display: none;' }}">
                                                <div
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                @php($download_rider_app_main_button_title = \App\Models\DataSetting::withoutGlobalScope('translate')->where('type', 'react_landing_page')->where('key', 'download_rider_app_main_button_title')->first())
                @php($download_rider_app_main_button_sub_title = \App\Models\DataSetting::withoutGlobalScope('translate')->where('type', 'react_landing_page')->where('key', 'download_rider_app_main_button_sub_title')->first())
                @php($download_rider_app_links = \App\Models\DataSetting::where(['key'=>'download_rider_app_links','type'=>'react_landing_page'])->first())
                @php($download_rider_app_links_data = isset($download_rider_app_links->value) ? json_decode($download_rider_app_links->value, true) : [])
                <form
                    action="{{ route('admin.business-settings.react-landing-page-settings-update', 'download-rider-app-button-section') }}"
                    method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="row g-4">
                                    <div class="col-12">
                                        @if ($language)
                                            <div class="col-md-12 lang_form default-form">
                                                <div class="row g-1">
                                                    ...
                                                    <i class="tio-info color-A7A7A7"></i>
                                                        ...
                                                        <input id="download_rider_app_main_button_title" type="text"
                                                               maxlength="100"
                                            ...
                                            @foreach($language as $lang)
                                                    <?php
                                                    if (isset($download_rider_app_main_button_title->translations) && count($download_rider_app_main_button_title->translations)) {
                                                        $download_rider_app_main_button_title_translate = [];
                                                        foreach ($download_rider_app_main_button_title->translations as $t) {
                                                            if ($t->locale == $lang && $t->key == 'download_rider_app_main_button_title') {
                                                                $download_rider_app_main_button_title_translate[$lang]['value'] = $t->value;
                                                            }
                                                        }

                                                    }
                                                    if (isset($download_rider_app_main_button_sub_title->translations) && count($download_rider_app_main_button_sub_title->translations)) {
                                                        $download_rider_app_main_button_sub_title_translate = [];
                                                        foreach ($download_rider_app_main_button_sub_title->translations as $t) {
                                                            if ($t->locale == $lang && $t->key == 'download_rider_app_main_button_sub_title') {
                                                                $download_rider_app_main_button_sub_title_translate[$lang]['value'] = $t->value;
                                                            }
                                                        }
                                                ...
                                                <div class="col-md-12 d-none lang_form" id="{{$lang}}-form1">
                                                    <div class="row g-1">
                                                        <div class="col-12">
                                                            <label for="download_rider_app_main_button_title{{$lang}}"
                                                                   class="form-label">{{translate('Title')}}
                                                    ...
                                                    <i class="tio-info color-A7A7A7"></i>
                                                        ...
                                                        <div class="col-12">
                                                            <label for="download_rider_app_main_button_sub_title{{$lang}}"
                                                                   class="form-label">{{translate('Sub Title')}}
                                                                ({{strtoupper($lang)}})<span
                                                                    class="form-label-secondary" data-toggle="tooltip"
                                                                    data-placement="right"
                                                    ...
                                                    <i class="tio-info color-A7A7A7"></i>
                                                            ...
                                                            <input type="text"
                                                                   id="download_rider_app_main_button_sub_title{{$lang}}"
                                                                   maxlength="200"
                                                                   name="download_rider_app_main_button_sub_title[]"
                                        ...
                                        <div class="bg-white rounded p-xxl-4 p-2">
                                            <div
                                                ...
                                                <label class="toggle-switch toggle-switch-sm m-0">
                                                    <input type="checkbox" name="rider_playstore_url_status"
                                                           id="play-store-rider-status"
                                                           data-id="play-store-rider-status"
                                                           data-type="toggle"
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                                        <label for="playstore_url"
                                                            ...
                                                            @include('admin-views.business-settings.landing-page-settings.partials._app-download-link-status', [
                                                                'isConfigured' => \App\CentralLogics\Helpers::get_business_settings('app_url_android_rider'),
                                                            ])
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="bg-white rounded p-xxl-4 p-2">
                                            <div
                                                ...
                                                <label class="toggle-switch toggle-switch-sm m-0">
                                                    <input type="checkbox" name="rider_apple_store_url_status"
                                                           data-id="apple-rider-status"
                                                           data-type="toggle"
                                                ...
                                                <div class="form-group mb-md-0">
                                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                                        <label for="apple_store_url"
                                                            ...
                                                            @include('admin-views.business-settings.landing-page-settings.partials._app-download-link-status', [
                                                                'isConfigured' => \App\CentralLogics\Helpers::get_business_settings('app_url_ios_rider'),
                                                            ])
                                                </div>
                                            </div>
                                        </div>
        ...
        <form action="{{ route('taxvat.store') }}" method="post">
            <div>
                <div
                    ...
                    <div class="py-1">
                        <h3 class="mb-0 line--limit-1">{{ translate('messages.Rider App Download Section Preview') }}</h3>
                    </div>
                    <button type="button"
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="selling-thumb min-w-176px max-w-250">
                                    <img width="180"
                                         src="{{ $download_rider_app_image?->value
    ? \App\CentralLogics\Helpers::get_full_url('download_rider_app_section', $download_rider_app_image->value, $download_rider_app_image->storage[0]?->value ?? 'public', 'aspect_1')
    :asset('/public/assets/admin/img/400x400/rider-dirver.png') }}"
                                         alt="Google Play" class="object-contain w-100 h-100">
                                </div>
                                <div class="mt-xl-0 mt-2 max-w-353px">
                                    <h2 class="mb-xxl-2 mb-1 fs-24">
                                        {!! \App\CentralLogics\Helpers::highlightWords($download_rider_app_title?->value ?? 'Ride More. $Earn$ More.') !!}
                                    </h2>
                                    @if($download_rider_app_sub_title?->value)
                                        <p class="text-title fs-12 mb-xxl-4 mb-xl-3 mb-3">
                                            {!!nl2br($download_rider_app_sub_title?->value)!!}
                                        </p>
                                    @else
                                        <p class="text-title fs-12 mb-xxl-4 mb-xl-3 mb-3">
                                        ...
                                        <ul class="list-checked d-flex flex-column gap-1 mb-xxl-4 mb-xl-3 mb-3">
                                            ...
                                            <li class="d-flex fs-14 align-items-center gap-2 text-title fw-medium">
                                                <img width="16" src="{{asset('public/assets/admin/img/icons/6check.png')}}"
                                                     alt="check" class="svg">
                                                {{ translate('Earn more with every trip and boost your income') }}
                                            </li>
                                            <li class="d-flex fs-14 align-items-center gap-2 text-title fw-medium">
                                                <img width="16" src="{{asset('public/assets/admin/img/icons/6check.png')}}"
                                                     alt="check" class="svg">
                            ...
                            <div>
                                <div class="bg-white py-3 px-sm-5 px-1 rounded-10">
                                    <div class="mb-20 text-center">
                                        <h3 class="mb-1">{{ $download_rider_app_main_button_title?->value ?? 'Download the Rider App' }}</h3>
                                        <p class="mb-0 fs-12">{{ $download_rider_app_main_button_sub_title?->value ?? 'Take control of your rides anywhere.' }}</p>
                                    </div>
...
@push('script_2')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var fileInput = document.querySelector('input[name="download_rider_app_image"]');
