...
@section('content')
    ...
    <div class="text-center text-white mb-4">
        <h2>Aduanefie Software Installation</h2>
    ...
    <div class="pb-2 px-2 px-sm-5 mx-xl-4">
        <div class="progress cursor-pointer" role="progressbar" aria-label="Aduanefie Software Installation"
        ...
        <div class="p-4 my-md-3 mx-xl-4 px-md-5">
            ...
            <div class="bg-light p-4 rounded mb-4">
                <div class="d-flex justify-content-between gap-1 align-items-center flex-wrap mb-4 pb-sm-3">
                    ...
                    <a href="https://Aduanefie.app/documentation/admin-application-configuration/local/"
