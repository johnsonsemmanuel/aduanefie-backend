            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select name="category_id" id="category_id" class="form-control js-select2-custom" required>
                        <option value="" {{ $equipment ? '' : 'selected' }}>{{ translate('Select Category') }}</option>
                ...
                @if ($store_categories && count($store_categories) > 0)
                    <div class="form-group">
                        <label class="input-label" for="store_category_id">{{ translate('Store Category') }}</label>
                        <select name="store_category_id" id="store_category_id" class="form-control js-select2-custom">
                            ...
                            @foreach ($store_categories as $storeCategory)
                                <option value="{{ $storeCategory->id }}" {{ $item?->store_category_id == $storeCategory->id ? 'selected' : '' }}>
                                    {{ $storeCategory->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-group mb-0">
                    ...
                    <small class="form-text text-muted">{{ translate('How many units of this equipment are available to book simultaneously?') }}</small>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card h-100">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">{{ translate('Leave empty for no maximum.') }}</small>
                </div>
                <div class="form-group mb-0">
                    ...
                    <small class="form-text text-muted">{{ translate('Visible to customers, e.g. "2019 model, minor scratches".') }}</small>
                </div>
            </div>
        </div>
    </div>
